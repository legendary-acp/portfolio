...
function LetsGetInTouch(){
    return(
        <div style={{ padding:'3rem 2rem 3rem 5rem', color:'#FFF', background:'#020202', boxShadow:" -1px 1px #77aaff -2px 2px #77aaff -3px 3px #77aaff -4px 4px #77aaff -5px 5px #77aaff" }}>
